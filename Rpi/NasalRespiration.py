...
localizer = YOLO("models/Screen_Yolov8.pt",task="detect")
...
while cap.isOpened():
    ...
    # imdata = cv.resize(imdata, (640, 640))
    if frame_number % 2 == 0:
    ...
    cv.putText(imdata, f"Frame: {frame_number}", (10, 10), cv.FONT_HERSHEY_SIMPLEX, 0.3, (255, 255, 255), 1)
    ...
    if len(nasal_resp) > 200 :
        ...
        signal = savgol_filter(nasal_resp, 21, 3)
